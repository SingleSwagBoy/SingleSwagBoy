 ...
 * @LastEditors: HuangQS
 * @LastEditTime: 2021-10-14 16:27:18
...
export { default as MyArea} from "./area/index"                                     //地域组件[黄秋实]
export { default as MyChannel } from "./cannel/index"                               //渠道组件[黄秋实] 不用单独配置 但必须要在外层包裹Form组件，反应速度更快，示例：[停服下线通知配置|offineConfig.jsx]
