                ...
                >
                    {
                        ...
                        >
                            ...
                            <Form.Item
                                label="节目名"
                                name="showTitle"
                                rules={[{ required: true, message: '请输入节目名' }]}
                            >
                                <Input />
                            </Form.Item>
                            <Form.Item
                                label="节目详情"
                                name="showDetail"
                                rules={[{ required: true, message: '请输入节目详情' }]}
                            >
                                <Input />
                            </Form.Item>
                            <Form.Item label="头图地址" rules={[{ required: true, message: '请上传头图地址' }]}                            >
                                <Form.Item
                                    name="picUrl"
                                    rules={[{ required: true, message: '请上传头图地址' }]}
                                    style={{ display: 'inline-flex', width: 'calc(70% - 8px)', }}
                                >
                                ...
                                <Form.Item
                                    name="picUrl"
                                    style={{ display: 'inline-flex', width: 'calc(30%)', }}
                                >
                            ...
                            <Form.Item label="节目图地址" rules={[{ required: true, message: '请上传头图地址' }]}    >
                                <Form.Item name="adImg" rules={[{ required: true, message: '请上传头图地址' }]} style={{ display: 'inline-flex', width: 'calc(70% - 8px)', }}
                                >
                                    <Input.TextArea />
                                </Form.Item>
                                <Form.Item
                            ...
                            <Form.Item label="预告片" rules={[{ required: true, message: '请上传预告片' }]}>
                                <Form.Item
                                    name="source"
                                    // rules={[{ required: true, message: '请上传预告片' }]}
                                    style={{ display: 'inline-flex', width: 'calc(70% - 8px)', }}
                                >
                                    <Input.TextArea />
                                </Form.Item>
